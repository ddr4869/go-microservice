...
import (
	...
	"github.com/ddr4869/go-microservices/src/movie-microservice/common"
	"github.com/ddr4869/go-microservices/src/movie-microservice/controllers"
	"github.com/ddr4869/go-microservices/src/movie-microservice/databases"
	"github.com/gin-gonic/contrib/jwt"
	"github.com/gin-gonic/gin"

	_ "github.com/ddr4869/go-microservices/src/movie-microservice/docs"
...
func main() {
	...
	// Simple group: v1
	v1 := m.router.Group("/seedotech.moviemanagement/api/v1")
