...
import (
	...
	"github.com/ddr4869/go-microservices/src/user-microservice/common"
	"github.com/ddr4869/go-microservices/src/user-microservice/daos"
...
func (u *User) Authenticate(ctx *gin.Context) {
	...
	// var user models.User
	var err error
	_, err = u.userDAO.Login(user.Name, user.Password)

	if err == nil {
		var tokenString string
		// Generate token string
		tokenString, err = u.utils.GenerateJWT(user.Name, "")
		if err != nil {
